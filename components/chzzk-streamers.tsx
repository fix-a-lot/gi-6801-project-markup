    ...
    <section data-component="치지직스트리머" className="rounded-md border border-border bg-surface">
      ...
      <div className="grid grid-cols-2 gap-2 p-3 sm:grid-cols-3">
        {streamers.map(streamer => (
          <div
            key={streamer}
            className="flex min-h-20 flex-col justify-between rounded-sm border border-border bg-surface-2 p-2"
          >
            <span className="w-fit rounded-sm bg-fall px-1 py-0.5 text-[9px] font-bold text-primary-foreground">
              LIVE
            </span>
